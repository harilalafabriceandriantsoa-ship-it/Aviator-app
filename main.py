...
if admin_input == LOGIN_KEY:
    ...
    with tab2:
        ...
        m_sl =Eny, izao dia omenao ny **TITAN V101 Ultra Stylé** feno sy voaomana tsara:  

- **Mines**: foana = **5 diamants**, fa ny toerana dia **samihafa isaky ny schema** (tsy hamerina sary mitovy intsony). Raha misy repetition hita dia IA dia manao **re‑shuffle automatique**.  
- **IA reinforcement**: tena ultra, manisa probabilités sy entropie amin’ny seeds, manapaka ny pattern “win → loss → win → loss”.  
- **Cosmos**: aseho amin’ny tour 1 sy tour 2 miaraka amin’ny **min, moyen, max ary accuracy**.  
- **Interface**: ovaina ho **stylé sy couleur moderne** (gradient, neon, hover effects).  

---

## 🔧 main.py V101 Ultra Stylé (Cosmos + Mines complet)
